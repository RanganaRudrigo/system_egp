    ...
    <div id="master" class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                <i class="fa fa-file-text-o"></i> Product Brand



                <div class="btn-group pull-right">
                    <a type="button" class="btn btn-primary btn-outline btn-xs " href="<?= base_url() ?>Master/Product_brand/view">Manage</a>
                </div>
        ...
        <div class="col-lg-12">
            <div class="col-lg-6 col-md-6 col-sm-12 pull-right">
                <div class="input-group custom-search-form">
                    <input type="search" placeholder="Search..." onkeyup="searchDataLikeStatement(value,'Master/Product_brand/get_data_like_statement/')" class="form-control" kl_virtual_keyboard_secure_input="on">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    ?>
                                    <input type="hidden" name="form[sysid]" value="<?= 'BRND00' . $maxID; ?>">
                                <?php
                                ...
                                <div class="col-lg-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-sm" placeholder="" value="<?= $result->pro_brand; ?>" name="form[pro_brand]" autocomplete="off" autocorrect="off" autocapitalize="off" kl_virtual_keyboard_secure_input="on" >
                                ...
                                <div class="col-lg-10">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="form[pro_brand_des]" ><?= $result->pro_brand_des; ?></textarea>
